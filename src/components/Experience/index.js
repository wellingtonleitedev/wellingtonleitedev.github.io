    ...
    <Wrapper id="experience">
      ...
      <Timeline style={{ marginTop: 30 }} mode="left">
        <TimelineItem dot={<FaBuilding size={13} color="#52c41a" />}>
          <header>
            <h3>SMARAPD</h3>
            <p><FaSuitcase size={13} color="#0073b1" /> Desenvolvedor Full Stack</p>
            <small><FaCalendarAlt size={13} color="#0073b1" /> Ago. 2018 - Atualmente</small>
          </header>
          <article>
        ...
        <TimelineItem dot={<FaBuilding size={13} color="#1890ff" />}>
          <header>
            <h3>Williarts Gestão Web</h3>
            <p><FaSuitcase size={13} color="#0073b1" /> Desenvolvedor Full Stack</p>
            <small><FaCalendarAlt size={13} color="#0073b1" /> Jan. 2019 - Ago. 2019</small>
          </header>
          <article>
        ...
        <TimelineItem dot={<FaBuilding size={13} color="#1890ff" />}>
          <header>
            ...
            <p><FaSuitcase size={13} color="#0073b1" /> Desenvolvedor Web</p>
            <small><FaCalendarAlt size={13} color="#0073b1" /> Ago. 2018 - Jan. 2019</small>
          </header>
          <article>
        ...
        <TimelineItem dot={<FaBuilding size={13} color="#1890ff" />}>
          <header>
            <h3>BW Solutions</h3>
            <p><FaSuitcase size={13} color="#0073b1" /> Co-fundador</p>
            <small><FaCalendarAlt size={13} color="#0073b1" /> Dez. 2017 - Jun. 2018</small>
          </header>
          <article>
